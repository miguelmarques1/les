...
Router.patch("/coupons/:couponId/status", adminAuthorization, adminController.toggleCouponStatus.bind(adminController));
...
Router.patch("/returns/:returnId/status", adminAuthorization, adminController.updateReturnStatus.bind(adminController));
